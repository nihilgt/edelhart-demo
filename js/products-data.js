...
// Uses paths relative to the site root (repo root): "img/..." and "products/...".
...
window.EDELHART_PRODUCTS = [
    // 1. sss-gold — 11 images
    {
        ...
        images: Array.from({ length: 11 }, (_, i) =>
            `img/products/sss-gold/sss-gold-${i + 1}.jpeg`,
        ),
    },
    ...
    // 2. sss-silver — 11 images
    {
        ...
        price: 125,
        images: Array.from({ length: 11 }, (_, i) =>
            `img/products/sss-silver/sss-silver-${i + 1}.jpeg`,
        ),
    },
    ...
    // 3. squid — 4 images
    {
        ...
        images: Array.from({ length: 4 }, (_, i) =>
            `img/products/squid/squid-${i + 1}.jpeg`,
        ),
    },
    ...
    // 4. LEGS-pendant — 7 images
    {
        ...
        images: Array.from({ length: 7 }, (_, i) =>
            `img/products/LEGS-pendant/LEGS-pendant-${i + 1}.jpeg`,
        ),
    },
    ...
    // 5. EE-male-ring-BR-trap — 5 images
    {
        ...
        images: Array.from({ length: 5 }, (_, i) =>
            `img/products/EE-male-ring-BR-trap/EE-male-ring-BR-trap-${i + 1}.jpeg`,
        ),
    },
    ...
    // 6. EE-female-ring-gold — 5 images
    {
        ...
        price: 140,
        images: Array.from({ length: 5 }, (_, i) =>
            `img/products/EE-female-ring-gold/EE-female-ring-gold-${i + 1}.jpeg`,
        ),
    },
    ...
    // 7. EE-female-ring-silver — 5 images
    {
        ...
        price: 140,
        images: Array.from({ length: 5 }, (_, i) =>
            `img/products/EE-female-ring-silver/EE-female-ring-silver-${i + 1}.jpeg`,
        ),
    },
    ...
    // 8. EE-female-ring-BR — 4 images
    {
        ...
        price: 140,
        images: Array.from({ length: 4 }, (_, i) =>
            `img/products/EE-female-ring-BR/EE-female-ring-BR-${i + 1}.jpeg`,
        ),
    },
    ...
    // 9. EE-male-ring-silver — 4 images
    {
        ...
        price: 200,
        images: Array.from({ length: 4 }, (_, i) =>
            `img/products/EE-male-ring-silver/EE-male-ring-silver-${i + 1}.jpeg`,
        ),
    },
    ...
    // 10. EE-male-ring-BR — 5 images
    {
        ...
        price: 200,
        images: Array.from({ length: 5 }, (_, i) =>
            `img/products/EE-male-ring-BR/EE-male-ring-BR-${i + 1}.jpeg`,
        ),
    },
    ...
    // 13. EE-female-earring-br — 2 images
    {
        ...
        images: Array.from({ length: 2 }, (_, i) =>
            `img/products/EE-female-earring-br/EE-female-earring-br-${i + 1}.jpeg`,
        ),
    },
    ...
    // 14. Earring-shell — 2 images
    {
        ...
        price: 0,
        images: Array.from({ length: 2 }, (_, i) =>
            `img/products/Earring-shell/Earring-shell-${i + 1}.jpeg`,
        ),
    },
    ...
    // 15. earring-blue-gem — 5 images
    {
        ...
        price: 0,
        images: Array.from({ length: 5 }, (_, i) =>
            `img/products/earring-blue-gem/earring-blue-gem-${i + 1}.jpeg`,
        ),
    },
    ...
    // 16. ring-blue-gem — 4 images
    {
        ...
        price: 0,
        images: Array.from({ length: 4 }, (_, i) =>
            `img/products/ring-blue-gem/ring-blue-gem-${i + 1}.jpeg`,
        ),
    },
    ...
    // 17. necklace-blue-gem — 7 images
    {
        ...
        price: 0,
        images: Array.from({ length: 7 }, (_, i) =>
            `img/products/necklace-blue-gem/necklace-blue-gem-${i + 1}.jpeg`,
        ),
    },
    ...
    // 18. stingray-gold — 4 images
    {
        ...
        price: 0,
        images: Array.from({ length: 4 }, (_, i) =>
            `img/products/stingray-gold/stingray-gold-${i + 1}.jpeg`,
        ),
    },
    ...
    // 19. ring-gold-multi-gems — 4 images
    {
        ...
        price: 0,
        images: Array.from({ length: 4 }, (_, i) =>
            `img/products/ring-gold-multi-gems/ring-gold-multi-gems-${i + 1}.jpeg`,
        ),
    },
    ...
    // 20. ring-chameleon — 2 images
    {
        ...
        price: 0,
        images: Array.from({ length: 2 }, (_, i) =>
            `img/products/ring-chameleon/ring-chameleon-${i + 1}.jpeg`,
        ),
    },
    ...
    // 21. necklace-ants — 6 images
    {
        ...
        images: Array.from({ length: 6 }, (_, i) =>
            `img/products/necklace-ants/necklace-ants-${i + 1}.jpeg`,
        ),
    },
];